...
#
# from functions.service_function import mailing_order, delete_all_messages, get_moscow_time
#
...
#         mailing_order(order_id=int(order_id), order_type=data['order_type'], point_A=data['point_A'], point_B=data['point_B'],
